...
export default class levelOne extends Phaser.Scene {
    ...
    create() {
        ...
        this.time.delayedCall(17530, () => {
            ...
            finishLine.setVelocityY(500 * this.game.config.speedFactor);
        });
            ...
            const obstacleSpawnEvent = this.time.addEvent({
                ...
                callback: () => {
                    ...
                    if (this.isLaneClearForObstacle(laneX)) {
                        spawnSpecificObstacle(this, type, this.obstacles, laneX, 1, this.game.config.speedFactor)
                    }
                },
                callbackScope: this,
                loop: true
            ...
            const itemSpawnEvent = this.time.addEvent({
                ...
                callback: () => {
                    ...
                    if (this.isLaneClearForItem(laneX)) {
                        spawnSpecificItem(this, type2, this.items, laneX, 1, this.game.config.speedFactor)
                    }
                },
                callbackScope: this,
                loop: true
    ...
    update() {
        ...
        if (!this.isRestarting && !this.levelCompleted && !this.isPausedByUser) {
            const groundScrollSpeed = 500 * this.game.config.speedFactor; // pixels per second of background speed
